...
class Vertex:
    ...
    def add_adjacent(self, vertex: Vertex, weight: int):
        ...
        vertex.adjacent_vertices.update({self: weight})
...
class EdgeWeightedUndirectedGraph:
    ...
    def add_edge_between_vertices(
        self, from_vertex_key: Any, to_vertex_key: Any, weight: int
    ):
    ...
    def get_adjacent_vertices_for_vertex(self, vertex_key: Any):
...
if __name__ == "__main__":
    ...
    vertices = ["a", "b", "c", "d", "e"]
    graph = EdgeWeightedUndirectedGraph()
